...
/// scrolling physics.
///
/// The [CNApp] configures the top-level [Navigator] to search for routes
...
class CNApp extends StatefulWidget {
  /// Creates a MacosApp.
  ///
  ...
  /// Creates a [CNApp] that uses the [Router] instead of a [Navigator].
  CNApp.router({
    super.key,
