...
class _CNSearchFieldState extends State<CNSearchField> {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final width = widget.width ?? _intrinsicWidth ?? (constraints.hasBoundedWidth ? constraints.maxWidth : _kDefaultSearchFieldWidth);
  ...
  void _cacheCurrentProps() {
    ...
    _lastPlaceholderColor = resolveColorToArgb(widget.placeholderColor, context);
  ...
  Future<void> _syncPropsToNativeIfNeeded() async {
    ...
    final placeholderColor = resolveColorToArgb(widget.placeholderColor, context);
