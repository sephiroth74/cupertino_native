...
class CNToggle2 extends CNWidget {
  const CNToggle2({
    super.key,
    super.debugLog,
    required this.isOn,
    this.content,
    this.onChanged,
    this.toggleStyle = CNToggle2Style.automatic,
  ...
  /// Toggle style.
  final CNToggle2Style toggleStyle;
...
class _CNToggle2State extends CNWidgetState<CNToggle2> {
  @override
  ...
  double _defaultWidth() {
    switch (widget.toggleStyle) {
      case CNToggle2Style.automatic:
      case CNToggle2Style.switchStyle:
