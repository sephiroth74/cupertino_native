...
class CNSegmentedControlTheme extends InheritedTheme {
  ...
  const CNSegmentedControlTheme({super.key, required this.data, required super.child});
...
class CNSegmentedControlThemeData extends Equatable {
  ...
  static CNSegmentedControlThemeData lerp(CNSegmentedControlThemeData a, CNSegmentedControlThemeData b, double t) {
    return CNSegmentedControlThemeData(tintColor: Color.lerp(a.tintColor, b.tintColor, t));
  }
}
