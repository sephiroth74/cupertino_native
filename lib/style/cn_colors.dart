...
abstract final class CNColors {
  ...
  static const CupertinoDynamicColor teal =
      CupertinoDynamicColor.withBrightness(
  ...
  static const CupertinoDynamicColor purple =
      CupertinoDynamicColor.withBrightness(
        color: Color(0xFF963d95),
        darkColor: Color(0xFFCB30E0),
      );

  /// Standard pink accent — light: #FF375F · dark: #FF2D55
  static const CupertinoDynamicColor pink =
      CupertinoDynamicColor.withBrightness(
        color: Color(0xFFf8529e),
        darkColor: Color(0xFFFF2D55),
      );

  /// Standard brown accent — light: #B78A66 · dark: #AC7F5E
  static const CupertinoDynamicColor brown =
      CupertinoDynamicColor.withBrightness(
  ...
  static const CupertinoDynamicColor gray =
      CupertinoDynamicColor.withBrightness(
  ...
  static const CupertinoDynamicColor fillPrimary =
      CupertinoDynamicColor.withBrightness(
  ...
  static const CupertinoDynamicColor fillQuinary =
      CupertinoDynamicColor.withBrightness(
  ...
  static const List<CupertinoDynamicColor> fills = [
    fillPrimary,
    fillSecondary,
    fillTertiary,
    fillQuaternary,
  ...
  /// Canvas color
  static const CupertinoDynamicColor canvasColor =
      CupertinoDynamicColor.withBrightness(
  ...
  static const CupertinoDynamicColor secondaryBackgroundColor =
      CupertinoDynamicColor.withBrightness(
