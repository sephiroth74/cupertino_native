            ...
            const Row(
              ...
              children: [
                SizedBox(
                  width: 48,
                  height: 48,
                  child: CNImage(systemSymbolName: 'heart'),
                ),
                SizedBox(
                  width: 48,
                  height: 48,
                  child: CNImage(systemSymbolName: 'star'),
                ),
                SizedBox(
                  width: 48,
                  height: 48,
                  child: CNImage(systemSymbolName: 'bell'),
                ),
                SizedBox(
                  width: 48,
                  height: 48,
                  child: CNImage(systemSymbolName: 'figure.walk'),
                ),
              ],
            ),
            ...
            Row(
              ...
              children: [
                SizedBox(
                  ...
                  child: CNImage(
                    systemSymbolName: 'person.3.sequence',
                    symbolConfiguration: CNSymbolConfiguration.palette(const [
