...
class _TextFieldDemoPageState extends State<TextFieldDemoPage> {
  ...
  void _updateSelectionInfo() {
    ...
    if (selection.isValid && mounted) {
      setState(() {
        _selectionInfo = 'Selection: [${selection.baseOffset}, ${selection.extentOffset}]';
      });
    }
  }
    ...
    return CupertinoPageScaffold(
      ...
      child: SafeArea(
        child: ListView(
          ...
          children: [
            const Text('Default Text Field', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            const Text('Styled Text Field', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 12),
            CNTextField(
