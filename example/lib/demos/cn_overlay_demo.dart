...
class _OverlayDemoPageState extends State<OverlayDemoPage> {
  ...
  CNShape get _shape => switch (shape) {
    _ShapeKind.roundedRectangle =>
      CNRoundedRectangle(cornerRadius: cornerRadius, style: CNRoundedCornerStyle.continuous, inset: inset),
  ...
  CNOverlay get _overlay => switch (paint) {
    ...
    _PaintKind.strokeBorder =>
      CNOverlay.strokeBorder(_shape, color: useGradient ? null : tint, shapeStyle: _gradient, lineWidth: lineWidth),
  ...
  Widget build(BuildContext context) {
    ...
    return CNPageScaffold(
      navigationBar: const CNNavigationBar(middle: Text('Overlay')),
      child: CNContentArea(
