...
class CupertinoPopupMenuButtonNSView: NSView {
    ...
    private var popupMenu: NSMenu = .init()
    ...
    init(viewId: Int64, args: Any?, messenger: FlutterBinaryMessenger) {
        channel = FlutterMethodChannel(name: "CupertinoNativePopupMenuButton_\(viewId)", binaryMessenger: messenger)
        ...
        isTransparentOverlay = transparentOverlay
