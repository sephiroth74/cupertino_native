...
class CupertinoSecureTextFieldNSView: NSView, NSTextFieldDelegate, MySecureTextFieldDelegate {
    private let channel: FlutterMethodChannel
    private let textField = MySecureTextField(frame: .zero)
...
protocol MySecureTextFieldDelegate: NSObjectProtocol {
    @MainActor func textFieldDidChangeSelection(_ textField: MySecureTextField, _ range: NSRange)
}
